...
cloneDep 'third_party/libunwind/src' 'src/third_party/libunwind/src'
cloneDep 'third_party/cpu_features/src' 'src/third_party/cpu_features/src'
cloneDep 'third_party/depot_tools' 'src/third_party/depot_tools'
...
src/third_party/depot_tools/gclient sync